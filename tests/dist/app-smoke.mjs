...
if (cssMatch?.[1] !== undefined) {
  ...
  if (!css.includes('game-controls.is-terminal') || !css.includes('result-terminal-actions')) {
    throw new Error('app stylesheet must keep the terminal Undo action reachable after failure');
  }
}
